                    ...
                    return {
                        pre: function ($scope, iElement, iAttrs) {
                            ...
                            $scope.setCurrentHost = function (i) {
                                ...
                                console.log($scope.dataForMyMenu);
            ...
            BuildMenuHtml: function (leftMenuOptions) {
                var menuBody = ' <div class="sidebar" id="sidebar_cwLeftMenu">\
					            	...
					            	<li ng-repeat="rowOne in dataForMyMenu" >\
					            		<a href="{{rowOne.url}}"  ng-class="{\'dropdown-toggle\':rowOne.children.length>0,\'selected-menu-on\':rowOne.url == current_host.value || rowOne.display == \'block\'}" ng-click="setCurrentHost(rowOne)" >\
